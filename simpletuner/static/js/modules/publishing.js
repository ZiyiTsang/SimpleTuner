...
document.addEventListener('alpine:init', () => {
    ...
    window.publishingAuth = {
        ...
        async loginWithToken(token) {
            ...
            try {
                const response = await ApiClient.fetch('/publishing/token/save', {
                    method: 'POST',
                    headers: {
        ...
        async logout() {
            ...
            try {
                const response = await ApiClient.fetch('/publishing/token/logout', {
                    method: 'POST'
                });
        ...
        init(fieldId, initialValue) {
            ...
            return {
                ...
                async loadNamespaces(force = false) {
                    ...
                    try {
                        const response = await ApiClient.fetch('/publishing/namespaces');
                        if (!response.ok) {
                ...
                async checkAvailability() {
                    ...
                    try {
                        const response = await ApiClient.fetch('/publishing/repository/check', {
                            method: 'POST',
